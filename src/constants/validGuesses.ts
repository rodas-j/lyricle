...
export const VALID_GUESSES: Array<LyricsField> = [
  ...
  },
  {
    lyrics: [
      ...
      "Ed Sheeran - Thinking Out Loud - WINNERRecord of the YearD'Angelo & The Vanguard - Really Love",
      "Mark Ronson - Uptown Funk ft. Bruno Mars - WINNER",
      "Ed Sheeran - Thinking Out Loud",
    ],
    song: 'Ellie Goulding ─ Love Me Like You Do - From "Fifty Shades Of Grey"',
  },
  {
    lyrics: [
      "I figured it out",
