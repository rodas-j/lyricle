...
export const SongModal = ({
  ...
  const classes = classNames(
    'fixed z-20 pb-2 top-14 left-0 right-0 max-w-sm mx-auto shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden',
    {
