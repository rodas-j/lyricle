  ...
  return (
    <div className={styles.container}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Lyricle.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Your Lyricle, accessible from
            https://lyricle.app
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong> To better understand</strong> Your profile, interests,
            preferences to better our user experience on Lyricle.
          </p>
        </li>
        <li>
          <p>
            <strong>To manager Your requests: </strong> To attend and manage
            Your requests to Us.
          </p>
        </li>
        <li>
      ...
      <h2>User of External Tools on Website</h2>
      <p>
        We use Google Analytics to analyze user behavior to better improve user
        experience and for marketing purposes.
      </p>
      <h3>Google Analytics</h3>
      <p>
        Lyricle uses Google Analytics with the anonymization function. Google
        Analytics is a website analysis service used in our case, mainly for the
        optimization of user experience and measuring the effectiveness of
        marketing decisions.
      </p>
      <p>
        Google Analytics uses cookies. The information about your use on our
        website generated by the Google Analytics cookie is normally transmitted
        to a Google server in the USA and stored there. Google might disclose
        these personal data collected via the technical procedure to third
        parties.
      </p>
      <p>
        However, when IP anonymization is activated on our website, Google
        shortens your IP address within the Member States of the European Union
        or in other countries that are parties to the European Marketing Area
        Treaty. Only in exceptional cases is the full IP address transmitted to
        a Google server in the USA and shortened there. Google uses this
        information to analyze your use of the website in order to compile a
        report about your website activities and provide us with other services
        associated with your website and Internet use. The IP address of your
        browser transmitted by Google Analytics is not linked to any other
        Google data. Lyricle does not use your IP address in any way.
      </p>
      <p>
        This website also uses the UserID functions of Analytics in order to be
        able to track interaction data. This User ID is also anonymized and
        encrypted and is not linked to other data.
      </p>
      <p>
        You may prevent the storage of cookies by setting your browser software
        accordingly, but you might then not be able to fully use all functions
        of our website.
      </p>
      <p>
        You may furthermore prevent the disclosure of the data generated by the
        cookie which refer to the use of the website (incl. your IP address) to
        Google as well as the processing of these data by Google by downloading
      ...
      <p>
        ...
        data or information about website visitors may be transmitted to Google
        Analytics.
      </p>
      <p>
        Besides, a cookie left behind by Google Analytics may be erased at any
